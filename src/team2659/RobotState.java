...
import team2659.util.InterpolatingDouble;
import team2659.util.InterpolatingTreeMap;
...
public class RobotState {
	 ...
	 */
	    ...
	    public synchronized RigidTransform2d getPredictedFieldToVehicle(double lookahead_time) {
	        return getLatestFieldToVehicle().getValue().transformBy(RigidTransform2d.exp(vehicle_velocity_predicted_.scaled(lookahead_time)));
	    }
