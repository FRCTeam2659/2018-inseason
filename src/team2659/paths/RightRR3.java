...
public class RightRR3 implements PathContainer {
	public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(300,29,0,0));
        sWaypoints.add(new Waypoint(265,99,10,45));
        sWaypoints.add(new Waypoint(229,100,0,35));
