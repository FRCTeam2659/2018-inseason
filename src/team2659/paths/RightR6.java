...
public class RightR6 implements PathContainer {
	public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(280,123,0,0));
        sWaypoints.add(new Waypoint(227,123,0,35));
       /* sWaypoints.add(new Waypoint(258,70,0,0));
        sWaypoints.add(new Waypoint(258,127,0,50));
        sWaypoints.add(new Waypoint(226,125,0,40));*/
