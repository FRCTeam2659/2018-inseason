...
public class LeftLR2 implements PathContainer {
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(277,241,0,0));
        sWaypoints.add(new Waypoint(250,230,5,50));
        sWaypoints.add(new Waypoint(239,230,0,40));
