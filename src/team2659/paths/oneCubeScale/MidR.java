...
public class MidR implements PathContainer {
	public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(25,150,0,0));
        sWaypoints.add(new Waypoint(60,150,15,100));
        sWaypoints.add(new Waypoint(125,55,25,140));
        sWaypoints.add(new Waypoint(240,55,8,120));
        sWaypoints.add(new Waypoint(275,65,0,60));
