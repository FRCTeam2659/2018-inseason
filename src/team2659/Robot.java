...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		SmartDashboard.putData("cube gonna do", cubeChooser);
	...
	public void autonomousInit() {
		...
		if (cubeNum.equals("oneSwitch")) {
			if (position.equals("left")) {
				...
				case "LRL":
					...
					break;
				case "RLR":
					autonomousCommand = new OneCubeSwitchLeftR();
					break;
				case "RRR":
					autonomousCommand = new OneCubeSwitchLeftR();
					break;
				...
				case "RLR":
					...
					break;
				case "LRL":
					autonomousCommand = new OneCubeSwitchRightL();
					break;
				case "LLL":
					autonomousCommand = new OneCubeSwitchRightL();
					break;
		...
		//two cube auto
			...
			if (position.equals("left")) {
				switch (gameData.toUpperCase()) {
				case "LLL":
					autonomousCommand = new leftLL();
					break;
				case "LRL":
					autonomousCommand = new leftLR();
					break;
				case "RLR":
					autonomousCommand = new leftRL();
					break;
				case "RRR":
					autonomousCommand = new leftRR();
					break;
				}
			}
			else if (position.equals("middle")) {
	...
	public void teleopPeriodic() {
		Scheduler.getInstance().run();
		/*if (oi.driveStick.getRawButton(3) && oi.operatorStick.getRawButton(9))
			lifter.actuatePlatforms();
